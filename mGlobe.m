...
%% GUI
        ...
        uicontrol(p1_5,'units','characters','Position',[13.6 2.769 27.6 1.692],...
                    ...
                    'String','GLDAS/CLM|GLDAS/MOS|GLDAS/NOAH (0.25�)|GLDAS/NOAH (1�)|GLDAS/VIC|ERA Interim|MERRA (assimilation)|Other|GRACE|NCEP Reanalysis-2|MERRA2|NCEP Reanalysis-1|GLDASv2.1/NOAH (0.25�)|ERA5|LSDM',...
        ...
        uicontrol(p3_2,'units','characters','Position',[81 1.6 10 1.3],...
                    'Style','Pushbutton','String','ERA',...
                    'CallBack','mGlobe calc_down_era');
        uicontrol(p3_2,'units','characters','Position',[92.4 1.6 10 1.3],...            % 92.4 0.88 10 1.7
                    'Style','Pushbutton','String','NCEP',...
                    'CallBack','mGlobe calc_down_ncep');
        uicontrol(p3_2,'units','characters','Position',[81 0.2 10 1.3],...
                    'Style','Pushbutton','String','ERA5',...
                    'CallBack','mGlobe calc_down_era5');
        uicontrol(p3_2,'units','characters','Position',[92.4 0.2 10 1.3],...
